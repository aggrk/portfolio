...
const projects = [
  {
    ...
    title: "Natours API",
    description:
      "Production-grade RESTful API for tour management and booking. Features JWT authentication, role-based access control, advanced filtering, pagination, and geospatial queries.",
  ...
  },
  {
    ...
    title: "Rust API",
    description:
      "Lightweight RESTful API written in Rust. Demonstrates memory-safe systems programming with fast response times, structured error handling, and minimal overhead.",
  ...
  },
  {
    ...
    title: "Todo App",
    description:
      "Command-line task manager built in Rust. Supports adding, completing, and deleting tasks with persistent local storage and a clean, minimal CLI interface.",
    image: "/images/rust.png",
    tags: ["Rust"],
  ...
  },
  {
    ...
    description:
      "Full-featured tour booking interface powered by React Query. Includes user auth, interactive maps, booking flows, and a protected admin dashboard.",
  ...
  },
  {
    ...
    description:
      "Fast-paced trivia app with real-time score tracking, instant answer validation, and multiple question categories. Built with clean component architecture.",
  ...
  },
  {
    ...
    title: "Ecommerce API",
    description:
      "Scalable e-commerce backend with full product catalog management, cart sessions, order processing, and secure JWT-based user authentication.",
